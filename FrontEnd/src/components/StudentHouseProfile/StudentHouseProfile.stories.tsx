...
import StudentHousingProfile from './StudentHouseProfile';
import { StoryTemplate } from '@utils';

export default {
  title: 'StudentHousingProfile',
  component: StudentHousingProfile,
};

const Template = StoryTemplate<
  ComponentProps<typeof StudentHousingProfile>,
  typeof StudentHousingProfile
>(StudentHousingProfile);
...
Default.args = {
  ...
  address: '7039 Charmant Dr',
  distance: '20 mins',
  placeName: 'La Jolla Blue',
  rent: '980',
  numBed: '2',
  numBath: '2',
  utility: '75',
  ...
  genders: ['Prefer Female'],
  habits: ['Clean', '420 Friendly'],
  placeDescription:
