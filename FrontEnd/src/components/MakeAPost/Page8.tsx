...
import { WizardFormStep, TextArea, Subtitle2, RequiredAsterisk } from '@basics';
...
const Page8: FunctionComponent<WizardFormStep<Page8Store>> = ({
  setStore,
  validations,
  placeDescription,
}) => (
  <div className={styles.pageHeight}>
    ...
    <div className="d-flex justify-content-center">
      <TextArea
        ...
        error={validations?.placeDescription?.error}
